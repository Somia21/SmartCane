package com.somia.fyp.UI.fragment;
...
import com.somia.fyp.assistant.CommandInvoker;
import com.somia.fyp.Interfacess.IGoogleSpeechRecognzerError;
import com.somia.fyp.Interfacess.ITranlaterCallback;
import com.somia.fyp.utial.TTSService;
import com.somia.fyp.utial.sendToActivtys;
import com.somia.fyp.utial.Tranlater;
...
//        }, 10);
    ...
    private void yas(final ArrayList<String> matches) {
        ...
        new Tranlater(new ITranlaterCallback() {
            @Override
