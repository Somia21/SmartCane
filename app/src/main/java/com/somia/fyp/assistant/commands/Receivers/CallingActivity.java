...
public class CallingActivity extends AppCompatActivity implements INoNeedCommander, View.OnTouchListener{
    ...
    protected void intiCallingCountDown() throws Exception {
        MyTextToSpeech.intiTextToSpeech(CallingActivity.this, "hi", "आपकी कॉल की जा रही है");// Your call is being mde
    ...
    private class myRecipientCallingNumberFinder extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                Log.d("callingActivty", "requiredName=" + Query);
                ContentResolver cr = getContentResolver();//share data to other application
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            try {
                ...
                if (isRecipientNumberFound) {
                    ...
                    MyTextToSpeech.intiTextToSpeech(CallingActivity.this, "hi", getResources().getString(R.string.Sorry_App_Kasy_Call_karna_Chaatay_Ha));//to whom you want to make call
                    showVoiceRegonizerDiloge("en-IN");
