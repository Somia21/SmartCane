...
public class requestCommandAdapter extends RecyclerView.Adapter<requestCommandAdapter.ViewHolder> {
    private static final String TAG = "requestCommandAdapter";
     ...
     */
    public requestCommandAdapter(List<Command> dataSet) {
        mDataSet = dataSet;
    }
